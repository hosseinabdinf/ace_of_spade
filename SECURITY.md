...
**Countermeasures:** Both [Mouchet et al.'24](https://eprint.iacr.org/2024/194) and [Colin de Verdière et al.](https://eprint.iacr.org/2026/031) propose countermeasures enabling retries. Moreover, [Colin de Verdière et al.](https://eprint.iacr.org/2026/031) introduced a formal security model for MHE with synchronized decryptors (covering the case of retries), and show that the countermeasures proposed in [Mouchet et al.'24](https://eprint.iacr.org/2024/194) are insecure in the specific case of threshold decryption/key-switching (the countermeasures for the key-generation protocol are unaffected). However, none of these countermeasures is currently implemented in Lattigo, and retrying any MHE protocol must be considered insecure (even when executed by different sets of parties in the $t$-out-of-$N$ case).
